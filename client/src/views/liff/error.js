      ...
      <div className="w-full flex flex-wrap" style={{ height: "100%" }}>
        <div className="w-full flex-auto relative">
          <div className=" flex justify-between align-middle ">
            ...
            >
              <div
                className="border-t-0 px-6 align-middle border-l-0 border-r-0  text-green-mbk font-bold whitespace-nowrap p-4"
                style={{ fontSize: "24px" }}
              >
        ...
        <div
          ...
          style={{ width: "100%", height: "100px", borderRadius: "18px" }}
        >
          <div
            className="px-2 py-2 text-green-mbk"
