    ...
    return (
        <div className='fixed bottom-0 w-full z-2'>
            <div className="menu-box relative w-full pt-3">
                <div className="menu-list z-2 mx-auto font-bold flex justify-between w-full md:w-10/12 px-2">
                    {
                ...
                <div className="menu-bg w-full absolute bottom-0 bg-green-mbk"></div>
            </div>
        </div>
    )
}
