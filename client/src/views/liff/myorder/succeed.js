...
const Toreceive = () => {
    ...
    { value: "ได้รับสินค้าที่ไม่ตรงตามที่สั่งซื้อ เช่น ขนาดผิด หรือ ไม่ใช่สินค้าที่สั่งซื้อ เป็นต้น", label: "ได้รับสินค้าที่ไม่ตรงตามที่สั่งซื้อ เช่น ขนาดผิด หรือ ไม่ใช่สินค้าที่สั่งซื้อ เป็นต้น" },
                                            ...
                                            [...e.dt].map((dt, j) => {
                                                return <div key={j} className="w-full flex mb-2" style={{ fontSize: "12px" }}>
                                                    ...
                                                    <div className=" px-2 " style={{ width: "calc(100% - 80px)" }}>
                                                        ...
                                                        <div className="flex text-gold-mbk" style={{ fontSize: "16px" }}>
                                                            <i className=" flex fas fa-check-circle" style={{ alignItems: "center" }}></i>
                                                            <div className=" px-2">จัดส่งสำเร็จ</div>
                                                        </div>
                                                    </div>
                    ...
                    <div className="w-full flex-auto mt-2">
                        ...
                        <div className="mb-2 text-green-mbk" style={{
                            ...
                            <div className="flex px-2">
                                ...
                                <div> เการส่งหลักฐาน แจ้งเคลม หรือ คืนสินค้า</div>
                            </div>
                            <div className="px-3">
                                <div className="flex ">
