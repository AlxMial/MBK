...
const PaymentModal = ({ open, formik, handleModal
    , paymentImage
    , setPaymentImage
    , paymentImageQrCode
    ...
    const handleChangeImage = async (e) => {
        if (e.target.id === "filebankImageQrCode") {
            ...
            setPaymentImageQrCode({ ...paymentImageQrCode, image: base64, relatedTable: 'paymentQrCode' });
        } else {
            const base64 = await FilesService.convertToBase64(e.target.files[0]);
                    ...
                    <div className="w-full flex-auto mt-2">
                        ...
                        <div className="px-24 py-10 ">
                            ...
                            <div className="flex flex-wrap justify-center mt-4">
                                <div className="flex w-full px-4 margin-auto-t-b ">
                                    <div className="w-full lg:w-2/12 px-4 margin-auto-t-b ">
